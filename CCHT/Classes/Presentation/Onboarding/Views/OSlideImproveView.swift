...
private extension OSlideImproveView {
    func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            tag2.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 168.scale),
            tag2.widthAnchor.constraint(equalToConstant: 78.scale),
            tag2.heightAnchor.constraint(equalToConstant: 78.scale),
            tag2.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 349.scale : 266.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag3.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 114.scale),
            tag3.widthAnchor.constraint(equalToConstant: 120.scale),
            tag3.heightAnchor.constraint(equalToConstant: 120.scale),
            tag3.topAnchor.constraint(equalTo: topAnchor, constant: ScreenSize.isIphoneXFamily ? 430.scale : 347.scale)
        ])
        
        NSLayoutConstraint.activate([
            tag4.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 235.scale),
            tag4.widthAnchor.constraint(equalToConstant: 120.scale),
            tag4.heightAnchor.constraint(equalToConstant: 120.scale),
